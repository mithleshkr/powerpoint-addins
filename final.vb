...
'Do Something with the ActiveShape
 ...
 With ActiveShape
    .Fill.ForeColor.RGB = RGB(64, 224, 208)
    End With

End Sub

Sub DetermineActiveShape1()
'PURPOSE: Determine the currently selected shape in PowerPoint
'SOURCE: www.TheSpreadsheetGuru.com/the-code-vault
...
'Do Something with the ActiveShape
 ...
 With ActiveShape
    .Fill.ForeColor.RGB = RGB(255, 192, 203)
    End With

End Sub

Sub DetermineActiveShape5()
'PURPOSE: Determine the currently selected shape in PowerPoint
'SOURCE: www.TheSpreadsheetGuru.com/the-code-vault
...
'Do Something with the ActiveShape
 ...
 With ActiveShape
    .Fill.ForeColor.RGB = RGB(0, 0, 139)
    End With

End Sub

Sub DetermineActiveShape9()
'PURPOSE: Determine the currently selected shape in PowerPoint
'SOURCE: www.TheSpreadsheetGuru.com/the-code-vault
...
'Do Something with the ActiveShape
 ...
 With ActiveShape
    .Fill.ForeColor.RGB = RGB(173, 255, 47)
    End With
